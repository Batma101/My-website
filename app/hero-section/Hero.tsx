  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1-pkkRY0_gEzVIvL_SMpt9jt6NyynQxWA/view"
            target="_blank"
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
            href="https://github.com/Batma101"
            target="_blank"
          ...
          <Link
            href="https://www.linkedin.com/in/baktash-sahak-760a5a17a/"
            target="_blank"
        ...
        >
          ...
          >
            <Image
              src={profile}
              priority
              alt="Baktash's headshot"
              data-blobity-tooltip="Baktash"
